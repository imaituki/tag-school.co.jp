				...
				<form action="./_check.php#form" method="post">
					...
					<div class="row form_button">
						<div class="col-xs-6 mb20 pos_al">
							<a href="./_index.php?y={$arr_post.date|date_format:'%Y'}&m={$arr_post.date|date_format:'%m'}&d={$arr_post.date|date_format:'%d'}&w={$arr_post.date|date_format:'%w'}" class="button _back"><i class="fa fa-chevron-left"></i>時間選択に戻る</a>
						</div>
