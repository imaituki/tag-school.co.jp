...
<?php /*%%SmartyHeaderCode:19567463235eeb66d3a475f5-27355635%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '19567463235eeb66d3a475f5-27355635',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5eeb66d3a93247_87176197',
  'variables' => 
  array (
    '_ADMIN' => 0,
...
<?php if ($_valid && !is_callable('content_5eeb66d3a93247_87176197')) {function content_5eeb66d3a93247_87176197($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
							...
							<form method="post" action="" id="formSearch" enctype="multipart/form-data">
								<div class="col-sm-4">
									...
									<div class="input-group">
										<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['staff']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
" placeholder="キーワード" class="form-control">
										<span class="input-group-btn">
											...
											<a href="javascript:void(0)" class="reset_btn btn_reset"<?php if ($_smarty_tpl->tpl_vars['_SESSION']->value['admin']['staff']['search']['POST']['mode']!="search") {?> style="display:none;"<?php }?>> リセット</a>
