...
(function(t) {
    ...
    function l(n, i) {
        ...
        function Y(t, e) {
            var n, i;
            e && void 0 !== Ge[e] || (e = e || "day", n = te.getViewsWithButtons().join(" "), i = n.match(RegExp("\\w+" + z(e))), i || (i = n.match(/\w+Day/)), e = i ? i[0] : "agendaDay"), le = t, h(e)
        }
    ...
    function c(n) {
        ...
        function S(i, r) {
            var s, o, l, a, c = {};
            if (n.eventDataTransform && (i = n.eventDataTransform(i)), r && r.eventDataTransform && (i = r.eventDataTransform(i)), t.extend(c, i), r && (c.source = r), c._id = i._id || (void 0 === i.id ? "_fc" + Ae++ : i.id + ""), c.className = i.className ? "string" == typeof i.className ? i.className.split(/\s+/) : i.className : [], s = i.start || i.date, o = i.end, k(s) && (s = e.duration(s)), k(o) && (o = e.duration(o)), i.dow || e.isDuration(s) || e.isDuration(o)) c.start = s ? e.duration(s) : null, c.end = o ? e.duration(o) : null, c._recurring = !0;
            else {
                if (s && (s = N.moment(s), !s.isValid())) return !1;
                if (o && (o = N.moment(o), !o.isValid())) return !1;
                l = i.allDay, void 0 === l && (a = P(r ? r.allDayDefault : void 0, n.allDayDefault), l = void 0 !== a ? a : !(s.hasTime() || o && o.hasTime())), b(s, o, l, c)
            }
            return c
        }
        ...
        function E(e) {
            var n, i, r, s, o, l, a, c, d, u, h = [],
                f = A,
                g = Y;
            if (f && g || (n = N.getView(), f = n.start, g = n.end), e)
                if (e._recurring) {
                    if (r = e.dow)
                        for (i = {}, s = 0; r.length > s; s++) i[r[s]] = !0;
                    for (o = f.clone().stripTime(); o.isBefore(g);)(!i || i[o.day()]) && (l = e.start, a = e.end, c = o.clone(), d = null, l && (c = c.time(l)), a && (d = o.clone().time(a)), u = t.extend({}, e), b(c, d, !l && !a, u), h.push(u)), o.add(1, "days")
                } else h.push(e);
            return h
        }
        ...
        function L(t, e, n, i, r) {
            ...
            for (l = 0; q.length > l; l++)
                if (a = q[l], (!r || r._id !== a._id) && G(a, t, e)) {
                    ...
                    if (r) {
                        if (c = P(a.overlap, (a.source || {}).overlap), c === !1) return !1;
    ...
    function be(n) {
        ...
        (function() {
            ...
            for (var e = 0, n = 0; 7 > e; e++) L[e] = n, F[e] = -1 != t.inArray(e, R), F[e] || (z[n] = e, n++);
