							...
							<div class="col-sm-4">
								...
								<div class="input-group">
									<select class="form-control" name="search_teacher">
										...
										{html_options options=$OptionTeacher selected=$arr_post.search_teacher|default:""}
									</select>
									<input type="hidden" name="search_date_start" value="{$arr_post.search_date_start}">
									<input type="hidden" name="search_date_end" value="{$arr_post.search_date_end}">
									<!-- <input type="text" id="search_keyword" name="search_keyword" value="{$_SESSION.admin.article_category.search.POST.search_keyword|default:""}" placeholder="キーワード" class="form-control"> -->
