<?php /* Smarty version Smarty-3.1.18, created on 2020-06-29 12:59:51
         compiled from "../template/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5059280285ef70a2e12f3f6-14120932%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5059280285ef70a2e12f3f6-14120932',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5ef70a2e525dd2_51286957',
  'variables' => 
  array (
    '_ADMIN' => 0,
...
<?php if ($_valid && !is_callable('content_5ef70a2e525dd2_51286957')) {function content_5ef70a2e525dd2_51286957($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
							...
							<form method="post" action="" id="formSearch" enctype="multipart/form-data">
								<div class="col-sm-4">
									...
									<div class="input-group">
										<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['teacher']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
