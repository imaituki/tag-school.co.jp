...
$objMember = new FT_member( $objManage, $_ARR_MAIL["reissue"]["savePath"] );
...
if( empty($message["ng"]) ) {
	...
	$arr_post["temp_password"]   = fn_encrypt( $temp_password, _CRYPTKEY );
	$arr_post["temp_time_limit"] = date( "Y-m-d H:i:s", strtotime("+24 hour") );
