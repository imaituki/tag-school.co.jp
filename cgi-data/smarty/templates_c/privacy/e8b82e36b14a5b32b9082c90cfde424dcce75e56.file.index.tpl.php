<?php /* Smarty version Smarty-3.1.18, created on 2020-01-23 17:23:03
	...
	<section>
		<div class="wrapper bg_common" >
			<div class="center">
				...
				<div class="box bg0">
					<h3 class="box_title">1. 個人情報の管理</h3>
					...
					<h3 class="box_title">2.個人情報の利用目的</h3>
					<p class="mb50 c_g">当社は、お客さまの個人情報を正確かつ最新の状態に保ち、個人情報への不正アクセス・紛失・破損・改ざん・漏洩などを防止するため、セキュリティシステムの維持・管理体制の整備・社員教育の徹底等の必要な措置を講じ、安全対策を実施し個人情報の厳重な管理を行ないます。</p>
					<h3 class="box_title">3.個人情報の利用目的</h3>
					<p class="mb50 c_g">当社は、お客さまよりお預かりした個人情報を適切に管理し、次のいずれかに該当する場合を除き、個人情報を第三者に開示いたしません。<br>
					・お客さまの同意がある場合<br>
					・お客さまが希望されるサービスを行なうために当社が業務を委託する業者に対して開示する場合<br>
					・法令に基づき開示することが必要である場合</p>
					<h3 class="box_title">4.個人情報の安全対策</h3>
					<p class="mb50 c_g">当社は、個人情報の正確性及び安全性確保のために、セキュリティに万全の対策を講じています。</p>
					<h3 class="box_title">5.ご本人の照会</h3>
					<p class="mb50 c_g">お客さまからお預かりした個人情報は、当社からのご連絡や業務のご案内やご質問に対する回答として、電子メールや資料のご送付に利用いたします。</p>
					<h3 class="box_title">6.法令、規範の遵守と見直し</h3>
					<p class="mb50 c_g">当社は、保有する個人情報に関して適用される日本の法令、その他規範を遵守するとともに、本ポリシーの内容を適宜見直し、その改善に努めます。</p>
					<h3 class="box_title">7.お問い合わせ</h3>
					<p class="mb10 c_g">当社の個人情報の取扱に関するお問い合せは下記までご連絡ください。</p>
					<p class="mb50 c_g">株式会社TAG Corporation28<br />
						〒700-0973 岡山県岡山市北区下中野1200番4号 5F<br />
						TEL：<span class="tel" data-tel="000-0000-0000">000-0000-0000</span>　FAX：000-0000-0000<br>
						E-mail：<a href="mailto:info@tag-school.co.jp">info@tag-school.co.jp</a>
					</p>
				</div>
			</div>
		</div>
