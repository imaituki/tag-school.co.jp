<?php /* Smarty version Smarty-3.1.18, created on 2020-06-10 18:37:22
         compiled from "/home/tag-school/www/admin/contents/online-consultation/template/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10823885995ee0a9d2354800-31861931%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2352db512f4dee8eb329e0e4a1687b4cb9b585b0' => 
    array (
      0 => '/home/tag-school/www/admin/contents/online-consultation/template/list.tpl',
      1 => 1591778580,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10823885995ee0a9d2354800-31861931',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee0a9d23b9361_96786376',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee0a9d23b9361_96786376')) {function content_5ee0a9d23b9361_96786376($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/tag-school/cgi-data/smarty/libs/plugins/modifier.date_format.php';
?><style>
.tbl_calendar {
	width: 100%;
	table-layout: fixed;
...
" class="btn btn-primary btn-s" style="color:#FFF; text-decoration: none; font-weight: bold;">&lt;<span class="hidden-xs"> 前月へ</span></a>
			&nbsp;
...
" class="btn btn-primary btn-s" style="color:#FFF; text-decoration: none; font-weight: bold;"><span class="hidden-xs">次月へ </span>&gt;</a>
		</span>
	</p>
	<div align="center">
...
<?php if ($_smarty_tpl->tpl_vars['detail']->value['cancel_flg']==1) {?><br>※キャンセル<?php }?></a>
						</div>
					<?php } ?>
				</td>
			<?php } else { ?>
