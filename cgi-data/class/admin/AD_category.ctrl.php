...
class AD_category {
	...
	// 主テーブル
	var $_CtrTable   = "mst_category";
	var $_CtrTablePk = "id_category";

	// コントロール機能（ログ用）
	var $_CtrLogName = "カテゴリ";
	...
	function check( $arrVal, $mode ) {
		...
		if( strcmp($mode, "update") == 0 ) {
			$objInputCheck->entryData( "記事カテゴリID", "all", $arrVal[$this->_CtrTablePk], array("CHECK_EMPTY", "CHECK_NUM"), null, null );
		}
