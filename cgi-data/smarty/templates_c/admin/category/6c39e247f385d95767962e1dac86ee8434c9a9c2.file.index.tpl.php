<?php /* Smarty version Smarty-3.1.18, created on 2020-01-21 17:09:10
         compiled from "../template/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20580306395e26aec22ee4a1-15840722%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20580306395e26aec22ee4a1-15840722',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5e26aec2338390_86988772',
  'variables' => 
  array (
    '_ADMIN' => 0,
...
<?php if ($_valid && !is_callable('content_5e26aec2338390_86988772')) {function content_5e26aec2338390_86988772($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
/">Home</a></li>
					...
					<div class="col-lg-8 recture">
						
					</div>
					<div class="col-lg-2 m-b-xs pos_ar mt30" style="margin-top:30px;">
							...
							<form method="post" action="" id="formSearch" enctype="multipart/form-data">
								<div class="col-sm-4">
									...
									<div class="input-group">
										<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['category']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
