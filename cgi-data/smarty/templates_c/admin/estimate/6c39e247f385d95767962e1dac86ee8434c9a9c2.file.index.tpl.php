...
<?php /*%%SmartyHeaderCode:15029508425dd4873a9f4c21-77365550%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '15029508425dd4873a9f4c21-77365550',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5dd4873ab998c5_53917521',
  'variables' => 
  array (
    '_ADMIN' => 0,
...
<?php if ($_valid && !is_callable('content_5dd4873ab998c5_53917521')) {function content_5dd4873ab998c5_53917521($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							<div class="form-group">
								<label class="control-label" for="date_added">見積り日</label>
								<div class="input-daterange input-group" id="datepicker">
									<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									<input type="text" class="input-sm form-control datepicker" name="search_date_start" id="search_date_start" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['estimate']['search']['POST']['search_date_start'])===null||$tmp==='' ? '' : $tmp);?>
" readonly>
									<span class="input-group-addon">～</span>
									<input type="text" class="input-sm form-control datepicker" name="search_date_end" id="search_date_end"  value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['estimate']['search']['POST']['search_date_end'])===null||$tmp==='' ? '' : $tmp);?>
" readonly>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['estimate']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>
