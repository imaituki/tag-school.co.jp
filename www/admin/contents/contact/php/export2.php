...
// 備考
if( empty($data["reason"]) && $data["comment"] && $data["memo"] ){
	$tcpdf->fontAutoCell( $tcpdf, _W180, _H28 , "", 1, 'L', 0, 0, NULL, NULL, NULL, NULL, NULL, true, _H28 , _FONT_SIZE10 );
}else{
	$tcpdf->Ln();
	$tcpdf->fontAutoCell( $tcpdf, _W180, _H250 , "入塾希望理由: \n". $data["reason"]. "\n\nお問い合わせ内容: \n". $data["comment"]. "\n\n備考: \n". $data["memo"], 1, 'L', 0, 0, NULL, NULL, NULL, NULL, NULL, true, _H250 , _FONT_SIZE10 );
}
